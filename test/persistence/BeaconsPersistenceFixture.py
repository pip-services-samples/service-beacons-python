# -*- coding: utf-8 -*-
"""
    test.BeaconsPersistenceFixture
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    BeaconsPersistenceFixture class
...
class BeaconsPersistenceFixture():
    ...
    def test_create_beacons(self):
        ...
        assert beacon3.center is not None
    ...
    def test_get_with_filter(self):
        ...
        # Filter by udis
        page = self._persistence.get_page_by_filter(None, FilterParams.from_tuples("udis", '00001,00003'),
                                                    PagingParams())
        assert page is not None
